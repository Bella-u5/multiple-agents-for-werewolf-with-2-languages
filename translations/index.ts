...
const en = {
    ...
    getApiKey: 'Get a key at DeepSeek Platform',
    offlineNotice: 'No API key detected: the game still runs end-to-end, but agent speeches come from built-in strategy templates. Paste your DeepSeek API key above to watch real LLM agents play.',
...
const zh: typeof en = {
    ...
    getApiKey: '在 DeepSeek 开放平台获取',
    offlineNotice: '未检测到 API Key：游戏仍可完整运行，但 Agent 发言由内置策略模板生成。在上方填入 DeepSeek API Key，即可观看真实 LLM Agent 博弈。',
